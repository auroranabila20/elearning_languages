...
?>
 ...
 <div class="container mt-5 ml-2">
  <div class="row">
   <div class="jumbotron">
    <h4 class="text-center">Semua Kursus</h4>
    <?php 
          ...
          <div class="row">
              ...
              <div class="col-sm-6 mb-3">
                <div class="card-body">
                  ...
                  <small class="card-text">Durasi: <?php echo $row['course_duration']; ?></small><br />
                  <small class="card-text">Guru: <?php echo $row['course_author']; ?></small><br/>
                  <p class="card-text d-inline">Harga: <small><del>&#82;&#112; <?php echo $row['course_original_price'] ?> </del></small> <span class="font-weight-bolder">&#82;&#112; <?php echo $row['course_price']?> <span></p>
                  <a href="watchcourse.php?course_id=<?php echo $row['course_id'] ?>" class="btn btn-primary mt-5 float-right">Pelajari</a>
                </div>
              </div>
