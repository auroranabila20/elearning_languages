...
session_start();
 if(!isset($_SESSION['stuLogEmail'])) {
  ...
  <div class="container mt-5">
    ...
    <h3 class="mb-5">Selamat Datang di Halaman Pembayaran</h3>
    <form method="post" action="./paymentdone.php">
      ...
      <div class="form-group row">
       <label for="CUST_ID" class="col-sm-4 col-form-label">Email Murid</label>
       <div class="col-sm-8">
      ...
      <div class="form-group row">
       <label for="TXN_AMOUNT" class="col-sm-4 col-form-label">Harga</label>
       <div class="col-sm-8">
     ...
     <small class="form-text text-muted">Note: Selesaikan Pembayaran dengan memencet tombol</small>
     </div>
    </div>
  </div>
