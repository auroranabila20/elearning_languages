...
?>
    <div class="container-fluid bg-dark"> <!-- Start Course Page Banner -->
      <div class="row">
        <img src="./image/banner.png" alt="courses" style="height:300px; width:100%; object-fit:cover; box-shadow:10px;"/>
      </div> 
    ...
    <div class="container jumbotron mb-5">
     <div class="row">
      <div class="col-md-4">    
        <h5 class="mb-3">Jika sudah terdaftar? Silahkan masuk saja</h5>
       <form role="form" id="stuLoginForm">
         ...
         <button type="button" class="btn btn-primary" id="stuLoginBtn" onclick="checkStuLogin()">Masuk</button>
       </form><br/>
       <small id="statusLogMsg"></small>
      </div>
      <div class="col-md-6 offset-md-1">
      <h5 class="mb-3">Pengguna Baru !! Daftar</h5>
        <form role="form" id="stuRegForm">
           <div class="form-group">
             <i class="fas fa-user"></i><label for="stuname" class="pl-2 font-weight-bold">Nama</label><small id="statusMsg1"></small><input type="text"
           ...
           <i class="fas fa-envelope"></i><label for="stuemail" class="pl-2 font-weight-bold">Email</label><small id="statusMsg2"></small><input type="email"
             ...
             <small class="form-text">Kami tidak pernah membagikan Email yang anda kirim dengan siapapun.</small>
           </div>
           <div class="form-group">
             <i class="fas fa-key"></i><label for="stupass" class="pl-2 font-weight-bold">
               Password Baru</label><small id="statusMsg3"></small><input type="password" class="form-control" placeholder="Password" name="stupass" id="stupass">
           </div>
           <button type="button" class="btn btn-primary" id="signup" onclick="addStu()">Daftar</button>
        </form> <br/>
